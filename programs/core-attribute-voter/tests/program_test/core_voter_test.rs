...
use gpl_core_attribute_voter::state::max_voter_weight_record::{
...
impl CoreVoterTest {
    ...
    pub fn add_program(program_test: &mut ProgramTest) {
        program_test.add_program("gpl_core_attribute_voter", gpl_core_attribute_voter::id(), None);
    }

    #[allow(dead_code)]
    pub async fn start_new() -> Self {
        let mut program_test = ProgramTest::new("gpl_core_attribute_voter", gpl_core_attribute_voter::id(), None);
        ...
        let program_id = gpl_core_attribute_voter::id();
    ...
    pub async fn with_registrar_using_ix<F: Fn(&mut Instruction)>(
        ...
        let data =
            anchor_lang::InstructionData::data(&gpl_core_attribute_voter::instruction::CreateRegistrar {
                max_collections,
            });

        let accounts = anchor_lang::ToAccountMetas::to_account_metas(
            &gpl_core_attribute_voter::accounts::CreateRegistrar {
        ...
        let mut create_registrar_ix = Instruction {
            program_id: gpl_core_attribute_voter::id(),
            accounts,
            data,
        };
    ...
    pub async fn with_voter_weight_record_using_ix<F: Fn(&mut Instruction)>(
        ...
        let (voter_weight_record_key, _) = Pubkey::find_program_address(
            ...
            &gpl_core_attribute_voter::id(),
        );

        let data = anchor_lang::InstructionData::data(
            &gpl_core_attribute_voter::instruction::CreateVoterWeightRecord {
                governing_token_owner,
            },
        );

        let accounts = gpl_core_attribute_voter::accounts::CreateVoterWeightRecord {
            governance_program_id: self.governance.program_id,
    ...
    pub async fn with_max_voter_weight_record_using_ix<F: Fn(&mut Instruction)>(
        ...
        let data = anchor_lang::InstructionData::data(
            &gpl_core_attribute_voter::instruction::CreateMaxVoterWeightRecord {},
        );

        let accounts = gpl_core_attribute_voter::accounts::CreateMaxVoterWeightRecord {
            governance_program_id: self.governance.program_id,
            realm: registrar_cookie.account.realm,
            realm_governing_token_mint: registrar_cookie.account.governing_token_mint,
    ...
    pub async fn update_voter_weight_record(
        ...
        let data = anchor_lang::InstructionData::data(
            &gpl_core_attribute_voter::instruction::UpdateVoterWeightRecord {
                voter_weight_action,
            },
        );

        let accounts = gpl_core_attribute_voter::accounts::UpdateVoterWeightRecord {
    ...
    pub async fn update_max_voter_weight_record(
        ...
        let data = anchor_lang::InstructionData::data(
            &gpl_core_attribute_voter::instruction::UpdateMaxVoterWeightRecord {}
        );
    ...
    pub async fn relinquish_nft_vote(
        ...
        voter_cookie: &WalletCookie,
        voter_token_owner_record_cookie: &TokenOwnerRecordCookie,
        asset_vote_record_cookies: &[AssetVoteRecordCookie],
    ) -> Result<(), BanksClientError> {
        let data =
            anchor_lang::InstructionData::data(&gpl_core_attribute_voter::instruction::RelinquishNftVote {});
        ...
        let accounts = gpl_core_attribute_voter::accounts::RelinquishNftVote {
            registrar: registrar_cookie.address,
            voter_weight_record: voter_weight_record_cookie.address,
    ...
    pub async fn with_collection_using_ix<F: Fn(&mut Instruction)>(
        ...
        let accounts = gpl_core_attribute_voter::accounts::ConfigureCollection {
            registrar: registrar_cookie.address,
            realm: registrar_cookie.account.realm,
    ...
    pub async fn cast_asset_vote(
        ...
        let data = anchor_lang::InstructionData::data(&gpl_core_attribute_voter::instruction::CastNftVote {});

        let accounts = gpl_core_attribute_voter::accounts::CastNftVote {
            registrar: registrar_cookie.address,
            voter_weight_record: voter_weight_record_cookie.address,
            voter_token_owner_record: voter_token_owner_record_cookie.address,
            voter_authority: asset_voter_cookie.address,
